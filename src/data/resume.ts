...
export const skillGroups = [
  {
    ...
    skills: [
      { name: "C#", description: "Business logic, service layers, and maintainable back-end applications." },
      { name: ".NET", description: "API and application development for production business systems." },
      { name: "SQL Server", description: "Stored logic, reporting, and database-backed workflows." },
      { name: "REST APIs", description: "System-to-system communication and structured resource access." },
      { name: "SOAP APIs", description: "Legacy and enterprise integrations where SOAP contracts are required." },
      { name: "Python", description: "Automation, data processing, and back-end scripting." },
      { name: "FastAPI", description: "Lightweight API development for Python services." },
      { name: "Django", description: "Database-driven web applications and admin workflows." }
    ]
  },
  {
  ...
  },
  {
    title: "Databases",
    skills: [
      { name: "SQL Server", description: "Database logic, reporting, and backend persistence." },
      { name: "PostgreSQL", description: "Relational data storage for integrations, analytics, and monitoring." },
      { name: "MySQL", description: "Application storage and operational reporting." }
    ]
  },
  {
